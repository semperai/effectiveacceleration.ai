...
contract MockSablierLockup {
    ...
    function getCreateWithDurationsLLCallCount()
        external
        view
        returns (uint256)
    {
    ...
    function getCreateWithDurationsLLCall(
        uint256 index
    )
        external
        view
    ...
    {
        CreateWithDurationsLLCall storage call = createWithDurationsLLCalls[
            index
        ];
        return (
            call.sender,
    ...
    function createWithDurationsLD(
        ...
        createWithDurationsLLCalls.push(
            CreateWithDurationsLLCall({
