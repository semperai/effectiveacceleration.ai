module.exports = class Data1731954922292 {
    name = 'Data1731954922292'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "address_" text NOT NULL, "public_key" text NOT NULL, "name" text NOT NULL, "bio" text NOT NULL, "avatar" text NOT NULL, "reputation_up" integer NOT NULL, "reputation_down" integer NOT NULL, "average_rating" integer NOT NULL, "number_of_reviews" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`)
