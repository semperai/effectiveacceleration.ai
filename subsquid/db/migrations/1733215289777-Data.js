module.exports = class Data1733215289777 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "job" ("id" character varying NOT NULL, "state" integer NOT NULL, "whitelist_workers" boolean NOT NULL, "roles" jsonb NOT NULL, "title" text NOT NULL, "tags" text array NOT NULL, "content_hash" text NOT NULL, "content" text NOT NULL, "multiple_applicants" boolean NOT NULL, "amount" numeric NOT NULL, "token" text NOT NULL, "timestamp" integer NOT NULL, "max_time" integer NOT NULL, "delivery_method" text NOT NULL, "collateral_owed" numeric NOT NULL, "escrow_id" numeric NOT NULL, "result_hash" text NOT NULL, "rating" integer NOT NULL, "disputed" boolean NOT NULL, "allowed_workers" text array NOT NULL, "event_count" integer NOT NULL, "job_times" jsonb NOT NULL, "last_job_event_id" character varying, CONSTRAINT "PK_98ab1c14ff8d1cf80d18703b92f" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "push_subscription" ("id" SERIAL, "address" text NOT NULL, "endpoint" text NOT NULL, "expiration_time" integer, "keys" jsonb NOT NULL, CONSTRAINT "PK_07fc861c0d2c38c1b830fb9cb5d" PRIMARY KEY ("id"))`)
