module.exports = class Data1733215289777 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "notification" ("id" character varying NOT NULL, "type" integer NOT NULL, "address" text NOT NULL, "timestamp" integer NOT NULL, "job_id" text NOT NULL, CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`)
        await db.query(`CREATE SEQUENCE "push_subscription_id" START WITH 1`)
        await db.query(`CREATE TABLE "push_subscription" ("id" character varying NOT NULL DEFAULT ''||nextval('push_subscription_id'::regclass), "address" text NOT NULL, "endpoint" text NOT NULL, "expiration_time" integer, "keys" jsonb NOT NULL, CONSTRAINT "PK_07fc861c0d2c38c1b830fb9cb5d" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP SEQUENCE "push_subscription_id"`)
