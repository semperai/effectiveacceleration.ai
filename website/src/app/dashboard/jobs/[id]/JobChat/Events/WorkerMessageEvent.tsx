    ...
    <>
      <div className='relative'>
        {sender?.avatar ? (
          ...
          <div className='flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-500 ring-4 ring-white dark:ring-gray-900'>
      ...
      <div className='min-w-0 flex-1'>
        <div className='rounded-2xl bg-white p-4 shadow-sm dark:bg-gray-800'>
              ...
              <div className='flex items-center gap-2'>
                {isCurrentUser ? (
                  ...
                  >
                    {senderName}
                    {isArbitrator && (
                      <span className='ml-1 rounded bg-amber-100 px-1.5 py-0.5 text-xs text-amber-600 dark:bg-amber-900/30 dark:text-amber-400'>
                        Arbitrator
                      </span>
                    )}
          ...
          {/* File Indicator */}
          {isFormatted && (
            <div className='mt-3 inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-1.5 dark:border-blue-800 dark:bg-blue-950/20'>
