  ...
  <div className="max-w-2xl mx-auto w-full bg-white p-8 rounded-2xl shadow-xl text-center">
    <div className="mb-6">
      <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-4">
        <PiArrowsClockwise className="h-8 w-8 text-blue-500" />
      </div>
      <h2 className="text-2xl font-bold mb-2">Wrong Network</h2>
      <p className="text-gray-600 mb-6">
        EACC staking is only available on Arbitrum One. Please switch your network to continue.
      </p>
    </div>
    ...
    <button
      ...
      className={clsx(
        ...
        'from-blue-500 to-indigo-500 shadow-blue-500/25 hover:from-blue-400 hover:to-indigo-400',
