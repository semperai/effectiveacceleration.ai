      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='text-center'>
          ...
          <p className='mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300'>
            The world&apos;s first decentralized arbitration system powered by
            AI and governed by the community
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardContent className='pt-8'>
                  <div
                    className={`mb-4 inline-flex items-center justify-center rounded-xl p-3 ${colorClasses[feature.color as keyof typeof colorClasses]}`}
                  >
        ...
        <div className='mt-20 rounded-3xl bg-gradient-to-r from-gray-50 to-gray-100 p-8 md:p-12 dark:from-gray-800 dark:to-gray-900'>
          ...
          <div className='relative'>
            ...
            <div className='absolute left-0 right-0 top-1/2 hidden h-0.5 -translate-y-1/2 bg-gradient-to-r from-blue-200 via-indigo-300 to-purple-200 md:block dark:from-blue-800 dark:via-indigo-700 dark:to-purple-800' />
