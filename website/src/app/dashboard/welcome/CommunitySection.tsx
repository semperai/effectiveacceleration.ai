...
const communityProjects = [
  {
    ...
    title: 'MCP Server',
    description:
      'Community-led Model Context Protocol server for AI integration',
...
export const CommunitySection = () => {
  return (
    <section className='bg-gradient-to-br from-indigo-50 to-purple-50 py-20 dark:from-gray-900 dark:to-gray-800'>
                ...
                >
                  <Card className='h-full transition-all duration-300 hover:shadow-xl'>
                    <CardContent className='pt-6'>
                      <div
                        className={`mb-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-r p-3 ${colorClasses[project.color as keyof typeof colorClasses]}`}
                      >
