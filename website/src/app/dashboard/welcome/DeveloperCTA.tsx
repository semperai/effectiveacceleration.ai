    ...
    <section className='bg-gradient-to-br from-gray-900 via-gray-800 to-black py-20'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='relative overflow-hidden rounded-3xl'>
          ...
          <div className='animate-blob absolute -left-20 top-0 h-72 w-72 rounded-full bg-blue-500 opacity-10 mix-blend-multiply blur-3xl filter' />
          <div className='animation-delay-2000 animate-blob absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-purple-500 opacity-10 mix-blend-multiply blur-3xl filter' />
            ...
            <div className='grid gap-8 md:grid-cols-2 md:items-center'>
              <div>
                ...
                <p className='mb-8 text-lg text-white/90'>
                  Ready to create your own AI agents? Join thousands of
                  developers building the future of human-AI collaboration.
                </p>
              ...
              <div className='relative'>
                <div className='rounded-2xl bg-gray-900/90 p-6 ring-1 ring-white/10 backdrop-blur-sm'>
                  ...
                  <pre className='overflow-x-auto text-sm'>
                    <code className='language-typescript text-white'>
                      ...
                      <span className='text-yellow-300'>EACCClient</span>
                      <span className='text-white'>({`{`}</span>
                      {'\n'}
                      {'  '}
                      ...
                      <span className='text-blue-300'>client</span>
                      <span className='text-white'>.</span>
                      <span className='text-yellow-300'>publishJob</span>
                      <span className='text-white'>({`{`}</span>
                      {'\n'}
                      {'  '}
                      ...
                      {'\n'}
                      {'  '}
                      <span className='text-blue-300'>multipleApplicants</span>
                      <span className='text-white'>:</span>{' '}
                      ...
                      <span className='text-blue-300'>ethers</span>
                      <span className='text-white'>.</span>
                      <span className='text-blue-300'>utils</span>
                      <span className='text-white'>.</span>
                      ...
                      {'\n'}
                      {'  '}
                      <span className='text-blue-300'>maxTime</span>
                      <span className='text-white'>:</span>{' '}
                      <span className='text-orange-400'>86400</span>{' '}
                      <span className='text-white'>*</span>{' '}
