...
export const Hero = () => {
  return (
    <section className='relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700'>
      ...
      <div className='animate-blob absolute -left-20 top-1/4 h-72 w-72 rounded-full bg-purple-400 opacity-20 mix-blend-multiply blur-3xl filter' />
      <div className='animation-delay-2000 animate-blob absolute -right-20 top-1/3 h-72 w-72 rounded-full bg-blue-400 opacity-20 mix-blend-multiply blur-3xl filter' />
      <div className='animation-delay-4000 animate-blob absolute bottom-1/4 left-1/3 h-72 w-72 rounded-full bg-indigo-400 opacity-20 mix-blend-multiply blur-3xl filter' />

      <div className='relative'>
        <div className='mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pb-32 sm:pt-10 lg:px-8'>
