...
export const TokenSection = () => {
  ...
  const [circulatingSupply, setCirculatingSupply] = useState<string | null>(
    null
  );
  ...
  return (
    <section className='bg-gradient-to-br from-gray-50 to-white py-16 dark:from-gray-900 dark:to-gray-800'>
        ...
        <div className='grid gap-8 lg:grid-cols-2'>
          ...
          <div>
            <p className='mb-6 text-gray-700 dark:text-gray-300'>
              The EACC token powers the Effective Acceleration ecosystem. Earn
              tokens by participating in the platform and receive dividends from
              platform fees.
            </p>
