    ...
    <section className="relative bg-white py-16 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-8">
          ...
          >
            <div className="inline-flex items-center gap-4 px-2 md:w-full md:justify-center md:gap-8 md:px-0">
              {partners.map((partner) => (
                ...
                >
                  <div className="relative h-[45px] w-[100px] sm:h-[55px] sm:w-[120px] md:h-[70px] md:w-[155px] lg:h-[80px] lg:w-[175px] opacity-60 transition-opacity duration-300 group-hover:opacity-100">
                    <Image
                      src={partner.logo}
          ...
          {showScrollIndicator && (
            <>
              <div className="pointer-events-none absolute left-0 top-0 h-full w-8 bg-gradient-to-r from-white to-transparent dark:from-gray-900 md:hidden" />
              <div className="pointer-events-none absolute right-0 top-0 h-full w-8 bg-gradient-to-l from-white to-transparent dark:from-gray-900 md:hidden" />
            </>
          )}
        </div>
          ...
          <div className="mt-4 flex justify-center md:hidden">
            <div className="relative h-1 w-20 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
              <div 
                ...
                style={{ width: `${Math.max(20, 100 - scrollPosition * 0.8)}%`, transform: `translateX(${scrollPosition}%)` }}
              />
            </div>
          </div>
        )}
        ...
        {showScrollIndicator && (
          <div className="mt-2 flex justify-center gap-1 md:hidden">
            <span className="h-1 w-1 rounded-full bg-gray-300 text-xs dark:bg-gray-600">•</span>
            <span className="text-xs text-gray-400 dark:text-gray-500">Swipe for more</span>
            <span className="h-1 w-1 rounded-full bg-gray-300 text-xs dark:bg-gray-600">•</span>
          </div>
        )}
      </div>
