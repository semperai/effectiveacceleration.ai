...
const features = [
  {
    ...
    description: 'All messages and sensitive data are encrypted using industry-standard protocols',
    highlights: ['AES-256 encryption', 'Zero-knowledge architecture'],
  },
  {
    icon: Shield,
    title: 'Smart Contract Audited',
    description: 'Smart contracts audited by 0xguard for security and reliability',
          ...
          <div className="flex flex-col items-center text-center md:flex-row md:text-left">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our platform has been professionally audited by 0xguard to ensure the highest 
                level of security. We maintain a transparent security posture with public audit 
                reports and an active bug bounty program for continuous improvement.
              </p>
            </div>
          </div>
        </div>
