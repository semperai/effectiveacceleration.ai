...
import { PiBriefcase, PiPencilLine, PiBooks, PiHandWaving } from 'react-icons/pi';
      ...
      <div className="relative min-h-customHeader overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        ...
        <div className="relative flex min-h-customHeader items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
          <div className="w-full max-w-2xl">
            ...
            <div className="relative rounded-3xl bg-white/5 backdrop-blur-xl animate-in fade-in slide-in-from-bottom-4 duration-700">
              {/* Border gradient */}
              ...
              <div className="relative p-8 sm:p-12">
                ...
                <div className="mb-8 flex justify-center">
                  <div className="relative">
                    <div className="absolute inset-0 animate-pulse rounded-2xl bg-gradient-to-r from-red-500 to-orange-500 blur-xl opacity-50" />
                    <div className="relative inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-red-500/20 to-orange-500/20 px-4 py-2 backdrop-blur-sm ring-1 ring-red-500/50">
                      <AlertCircle className="h-5 w-5 text-white" />
                      <span className="text-sm font-semibold text-white">404 ERROR</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    {suggestions.map((item) => (
                      ...
                      >
                        ...
                        <div className="relative">
                          <div className={`mb-2 flex justify-center ${item.color} opacity-80 group-hover:opacity-100 transition-opacity`}>
                            {item.icon}
                          </div>
