              ...
              <div className="p-4">
                <div className="flex items-start">
                  <div className="ml-3 w-0 flex-1">
                    <p className="text-sm font-medium text-gray-900">Add Effective Acceleration to Homescreen</p>
                    <p className="mt-1 text-sm text-gray-500">Effective Acceleration can be installed locally for faster loading and less UI clutter.</p>
                        ...
                        onClick={async () => {
                          try {
                            ...
                            if (installed.outcome === 'accepted') {
                              localStorage.setItem("show_add_to_homescreen", "false");
                            }
                          } catch (e) {
                            console.error(e);
                          }
