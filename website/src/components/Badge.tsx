...
export function Badge({
  ...
  return (
    <span
      ...
      className={clsx(
        className,
        'inline-flex items-center gap-x-1.5 text-nowrap rounded-md px-1.5 py-0.5 text-sm/5 font-medium [word-break:break-word] sm:text-xs/5 forced-colors:outline',
        colors[color]
      )}
    />
  );
