...
const JobsAplications = ({filteredJobs, localJobs}: {filteredJobs: Job[], localJobs: Job[]}) => {
    ...
    return (
        <>
            <JobsTable table={tableCompletedTable} localJobs={localJobs} title='Job Aplications'></JobsTable>
        </>
    )
}
