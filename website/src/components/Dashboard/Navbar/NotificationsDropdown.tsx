...
>(
  (
    ...
    const messageNotificationCount = displayedNotifications.filter(
      (n) =>
        n.type === JobEventType.OwnerMessage ||
        n.type === JobEventType.WorkerMessage
    ).length;
        ...
        <div className='flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700'>
          ...
          <div className='flex items-center gap-1'>
            ...
            {isMobile && (
              <button
                onClick={onClose}
                className='rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 sm:hidden dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200'
    ...
    return (
      <div
        ref={ref}
        className='absolute right-0 mt-2 hidden w-96 max-w-[calc(100vw-2rem)] origin-top-right duration-200 animate-in fade-in slide-in-from-top-1 sm:block'
        style={{ zIndex: 9999 }}
      >
